...
\begin{figure}[!t]
\centering
\includegraphics[width=0.9\columnwidth]{../Figures/influence_editors.png}.
\caption{This is how \beta influences this editor rankings.}
\label{fig:influence_editors}
\end{figure}

\begin{figure}[!t]
\centering
\includegraphics[width=0.9\columnwidth]{../Figures/influence_articles.png}.
\caption{This is how \beta influences this editor rankings.}
\label{fig:influence_artilces}
\end{figure} 
