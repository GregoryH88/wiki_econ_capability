...
\title{The Virtuous Circle of Wikipedia\\ \vspace{0.3cm} {\LARGE \bf Recursive Measures of Collaboration Structures}\\ \vspace{0.3cm}}
...
\keywords{{\bf open collaboration, bi-partite networks, performance, coordination}}
...
%\bibliography{../tmaillart.bib,../additional.bib}

\input{formattedBib.tex}
